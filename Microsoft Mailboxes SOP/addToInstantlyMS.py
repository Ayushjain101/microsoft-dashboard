import sys
from main import bulkAddAccountToInstantlyMS


# print(sys.argv)
if len(sys.argv) < 4:
    # print("Please enter file path that contains account credential to add")
    print("Usage: addToInstantly.exe <Instantly Email> <Instantly Password> <email_file_path> <password_file_path> <optional: workspace name>")
    sys.exit(1)
...
thread = bulkAddAccountToInstantlyMS(
