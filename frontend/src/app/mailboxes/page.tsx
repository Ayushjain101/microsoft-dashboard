                    ...
                    {isExpanded && (
                      <tr className="bg-gray-50/50">
                        <td colSpan={8} className="px-6 py-3">
                          ...
                          {j.error_message && <div className="mt-2 p-3 bg-red-50 border border-red-200 rounded-xl text-xs text-red-700 font-mono whitespace-pre-wrap max-h-40 overflow-auto">{j.error_message}</div>}
                        </td>
                      </tr>
                    )}
                  </tbody>
